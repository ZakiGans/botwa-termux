...
➲GitHub Admin https://github.com/ZakiGans
...
➲ \`\`\`Mau Invit Bot?? Donasi Gan,\`\`\`
    \`\`\`Kalo Gamau Donasi SUB YT\`\`\`
     \`\`\`Subscribe Yt MilazuMZ\`\`\`
...
.. \`\`\`You Know Lah Karna Fitur Tersebut\`\`\`
   \`\`\`Membutuhkan Kuota Banyak Untuk Mendownload\`\`\`
    \`\`\`Dan Mengirimkan Audio/ Video Yang\`\`\`
     ...
     ➲SC INI GRATIS BUAT KALIAN KALO MAU HUB ADMIN
     ➲ Admin wa.me/083144780782
`
}
exports.rules = rules
